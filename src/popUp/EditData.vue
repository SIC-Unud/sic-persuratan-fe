<template>
  <div class="backdrop-blur-sm fixed inset-0 z-[98] bg-black/50">
    <div class="flex fixed md:inset-5 flex-col align-center justify-center md:w-[618px] md:h-[650px] md:mx-auto w-full h-full px-4 md:p-6 pt-14 bg-white md:rounded-2xl md:shadow-md md:border" @click="$emit('close')">
