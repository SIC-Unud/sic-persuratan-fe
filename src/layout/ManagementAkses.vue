<template>
    <!-- Tombol Tambah data -->
    <div>
        <button class="flex justify-self-end py-2 px-6 bg-primary rounded-xl gap-2 text-white" @click="TambahData">Tambah Data</button>
    </div>
        ...
        <table class="w-full table-auto mt-5">
            ...
            <tbody>
                ...
                <tr class="grid grid-cols-12 py-3 border-b-2 items-center">
                    ...
                    <td class="flex col-span-8 justify-self-start text-xs font-medium font-jakarta-sans">NASI GORENG MISI BE TALUH</td>
                    ...
                    <!-- satu baris -->
                    <tr class="grid grid-cols-12 py-3 border-b-2 items-center">
                        <td class="text-left justify-self-start pl-8 font-inter text-xs font-medium">2</td>
                        <td class="flex col-span-8 justify-self-start text-xs font-medium font-jakarta-sans">SICKHATON</td>
                        <td class="col-span-3 justify-self-center flex justify-center gap-4 pl-8">
                            <button>
                                <svg width="30" height="30" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M18 9.75C23.685 9.75 28.755 12.945 31.23 18C28.755 23.055 23.685 26.25 18 26.25C12.315 26.25 7.245 23.055 4.77 18C7.245 12.945 12.315 9.75 18 9.75ZM18 6.75C10.5 6.75 4.095 11.415 1.5 18C4.095 24.585 10.5 29.25 18 29.25C25.5 29.25 31.905 24.585 34.5 18C31.905 11.415 25.5 6.75 18 6.75ZM18 14.25C20.07 14.25 21.75 15.93 21.75 18C21.75 20.07 20.07 21.75 18 21.75C15.93 21.75 14.25 20.07 14.25 18C14.25 15.93 15.93 14.25 18 14.25ZM18 11.25C14.28 11.25 11.25 14.28 11.25 18C11.25 21.72 14.28 24.75 18 24.75C21.72 24.75 24.75 21.72 24.75 18C24.75 14.28 21.72 11.25 18 11.25Z" fill="#63A8E7"/>
